...
const WeatherIntentHandler = {
  ...
  async handle(handlerInput) {
    try {
      const apiKey = '2dc63a08d733b5eb86cfcab2e55cb3bc'; // Reemplaza con tu clave de API de OpenWeatherMap
      const lat =20.387582027197137; // Reemplaza con la latitud deseada
      const lon =   -97.88061431805382; // Reemplaza con la longitud deseada
